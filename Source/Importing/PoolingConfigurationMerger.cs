...
namespace Angar.Importers
{
    public class PoolingConfigurationMerger
    {
        ...
        public ITargetableFactory<IPoolDataSetProxy> DatasetProxyFactory { get; set; }
        ...
        public PoolingConfigurationMerger(ITargetableFactory<IPool<GameObject>> poolFactory,
            ...
            ITargetableFactory<IPoolDataSetProxy> datasetProxyFactory,
        ...
        public void Merge(GameObject prefab, IPoolDataSet dataset)
        {
        ...
        private void MergeDataset(IPoolDataSet datasetProxy, IPoolDataSet dataset)
        {
        ...
        public IPoolDataSetProxy GetOrCreateDataSetProxy(IPool<GameObject> pool)
        {
            var updater = GetUpdaterByPool(pool);

            if (updater != null)
                return updater.DataSet as IPoolDataSetProxy;
        ...
        public IPositionUpdater GetOrCreateUpdater(IPool<GameObject> pool, IPoolDataSet dataset)
        {
            var updater = GetUpdaterByPool(pool);
