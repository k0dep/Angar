...
public class PointOctree<T> where T : class {
    ...
    public void Pass(Vector3 position, float maxDistance, Action<PointOctreeNode<T>.OctreeObject> CheckFunc)
    {
        rootNode.Pass(ref position, ref maxDistance, ref CheckFunc);
    }
